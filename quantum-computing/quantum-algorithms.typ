...
*See also:* _Qubits and Gates_, _Complexity_, _Quantum Software Stack_, _Post-Quantum Cryptography_ (cryptography-and-security), _Complexity Theory_ (programming-languages)
