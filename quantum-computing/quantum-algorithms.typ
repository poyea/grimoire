...
*See also:* _Qubits and Gates_, _Complexity_, _Quantum Software Stack_, `cryptography-and-security/post-quantum.typ`, `programming-languages/complexity.typ`
...
Circuit: prepare $|0 angle.r^(times.o n) |1 angle.r$, apply $H^(times.o n+1)$, query the phase oracle $U_f: |x angle.r |y angle.r -> |x angle.r |y plus.circle f(x) angle.r$, apply $H^(times.o n)$ to the first register, measure. The output is $|0 angle.r^n$ iff $f$ is constant.
