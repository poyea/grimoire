...
*See also:* _Qubits and Gates_, _NISQ Devices and Benchmarking_, _Post-Quantum Cryptography_ (cryptography-and-security), _Complexity Theory_ (programming-languages)
