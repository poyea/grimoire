...
*See also:* #xref("numerical-computing", "error-analysis", label: "Error Analysis") (how rounding errors propagate through algorithms), #xref("numerical-computing", "linear-systems", label: "Linear Systems") (where conditioning amplifies rounding), #xref("numerical-computing", "optimization-algorithms", label: "Optimization Algorithms") (mixed-precision training pitfalls).
