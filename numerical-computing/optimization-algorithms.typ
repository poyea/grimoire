...
- *Active-set / SQP*: solve a sequence of quadratic programs modeling the Lagrangian; the QP's KKT system is a symmetric indefinite linear system ($L D L^top$ with Bunch-Kaufman — see #xref("numerical-computing", "linear-systems", label: "Linear Systems")). Excellent warm-starting; SNOPT and `SLSQP` live here.
