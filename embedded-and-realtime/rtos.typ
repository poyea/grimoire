...
*See also:* _Real-Time Scheduling_, _Peripherals and Drivers_, _Microcontrollers and SoC_, `linux-kernel/scheduler.typ`, `operating-systems/processes-and-threads.typ`
