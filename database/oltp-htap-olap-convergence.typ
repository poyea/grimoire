...
= OLTP / HTAP / OLAP Convergence <oltp-htap-olap-convergence>
...
*See also:* #xref("database", "column-stores-and-vectorized-execution", label: "Column Stores and Vectorized Execution"), #xref("database", "query-compilation", label: "Query Compilation"), #xref("database", "cloud-native-databases", label: "Cloud-Native Databases"), #xref("database", "storage-engines", label: "Storage Engines"), #xref("database", "transactions-distributed", label: "Distributed Transactions")
