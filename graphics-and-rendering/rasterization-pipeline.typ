...
Meshlets enable per-cluster culling (frustum, backface cone, $"HZB"$ occlusion) before rasterization — the foundation of Unreal Nanite (covered in `realtime-engines.typ`).
