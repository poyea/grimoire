...
*See also:* _Problem-Solving Patterns_ (pattern recognition and optimization strategies), _Reference_ (complexity cheat sheet, common recurrences, master theorem summary).
