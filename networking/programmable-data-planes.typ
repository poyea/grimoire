...
*See also:* _SDN and Programmable Networks_ (for OpenFlow, controllers), _Kernel Bypass_ (for XDP/AF_XDP software targets), _Data Center Networking_ (for in-network compute placement).
