...
*See also:* #xref("llm", "rlhf", label: "RLHF") (PPO-family algorithms reasoning RL extends), #xref("llm", "inference-optimization", label: "Inference Optimization") (long reasoning traces are decode-bound), #xref("llm", "evaluation", label: "Evaluation") (verifiable rewards for math/code benchmarks).
