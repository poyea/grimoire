...
*See also:* #xref("llm", "pretraining", label: "Pretraining") (how base weights are obtained), #xref("gpu-architecture", "ml-workloads", label: "ML Workload Optimization on GPUs (GPU Architecture volume)") (GEMM kernels, mixed-precision training), #xref("gpu-architecture", "memory-hierarchy", label: "GPU Memory Hierarchy (GPU Architecture volume)") (HBM bandwidth and capacity constraints).
