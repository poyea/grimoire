...
*See also:* #xref("llm", "pretraining", label: "Pretraining") (training loss, data quality), #xref("llm", "rlhf", label: "RLHF and Alignment") (reward model evaluation); #xref("search-and-ir", "evaluation", label: "Evaluation") (retrieval evaluation: relevance judgements and ranking metrics).
