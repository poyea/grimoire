...
*See also:* #xref("llm", "pretraining", label: "Pretraining") (consumes this output), #xref("llm", "tokenization", label: "Tokenization") (fit on the curated corpus), _Evaluation_ (contamination invalidates benchmarks).
