...
- *First-class continuations*. The redex for `callcc` captures the surrounding context as a value: $E["callcc" space v] arrow.r E[v space (lambda x. "abort"(E[x])) ]$. The captured continuation is a function that, when applied, restores $E$ as the entire context.
