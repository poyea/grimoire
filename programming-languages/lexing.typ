...
_See also: programming-languages/foundations.typ for regular languages and DFA theory. The present chapter is that theory made operational._
...
_See also: coding/string-algorithms.typ for Aho-Corasick and KMP, which answer related questions about multi-pattern search._
