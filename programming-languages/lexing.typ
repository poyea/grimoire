...
Aho, A. V., Lam, M. S., Sethi, R., Ullman, J. D. (2006). _Compilers: Principles, Techniques, and Tools_, 2nd ed. Addison-Wesley. Chapter 3 covers lexical analysis, DFA construction from regular expressions, and the minimisation of scanner automata.

Lesk, M. E. (1975). "LEX — A Lexical Analyser Generator." Bell Laboratories Computing Science Technical Report 39. The original lex paper; describes the tool that set the standard for scanner generators.

Cox, R. (2007). "Regular Expression Matching Can Be Simple and Fast." https://swtch.com/~rsc/regexp/regexp1.html. Explains why NFA simulation avoids exponential backtracking and why production lexers should never use backtracking engines.

Hopcroft, J. E. (1971). "An n log n Algorithm for Minimizing States in a Finite Automaton." Theory of Machines and Computations. The canonical DFA minimisation algorithm; underpins the efficient construction of minimal scanner automata.

Sipser, M. (2013). _Introduction to the Theory of Computation_, 3rd ed. Cengage Learning. Chapter 1 provides the theoretical foundation: NFAs, DFAs, the subset construction, and the equivalence with regular expressions.

Re2c Contributors. (2002–). "re2c: A Lexer Generator for C, C++, and Go." https://re2c.org/. The principal open-source lexer generator using the DFA-with-YYMARKER approach; the source code is an excellent case study of practical scanner construction.