...
*See also:* _Regular Languages_, _Omega-Automata_, #xref("programming-languages", "weighted-and-probabilistic-automata", label: "Weighted and Probabilistic Automata"), #xref("programming-languages", "turing-computability", label: "Turing Machines and Computability")
