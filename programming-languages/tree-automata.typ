...
*See also:* #xref("programming-languages", "infinite-trees-and-games", label: "Infinite Trees and Games"), _Omega-Automata_, #xref("programming-languages", "type-systems", label: "Type Systems")
