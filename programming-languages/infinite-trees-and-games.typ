...
*See also:* _Omega-Automata_, #xref("programming-languages", "tree-automata", label: "Tree Automata"), #xref("programming-languages", "turing-computability", label: "Turing Machines and Computability")
