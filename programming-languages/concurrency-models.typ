...
*See also:* #xref("programming-languages", "process-calculi", label: "Process Calculi"), #xref("programming-languages", "semantics", label: "Program Semantics"), #xref("networking", "concurrency-models", label: "Concurrency Models") (the same models applied to network servers).
