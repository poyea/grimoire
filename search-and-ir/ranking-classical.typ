...
*See also:* _Inverted Indexes_ (where tf and df live), _Query Processing_ (maximizing these scores under pruning), _Learning to Rank_ (these scores as features), _Neural Retrieval_ (learned alternatives and hybrids).
