...
*See also:* _Generalization Theory_ (PAC-Bayes, concentration), _Diffusion Models_ (KL, evidence lower bound), _Optimization_ (stochastic gradients as Monte Carlo), _Pretraining_ (cross-entropy as the training objective).
