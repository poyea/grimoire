...
*See also:* #xref("software-architecture", "architectural-styles", label: "Architectural Styles") (where EDA sits among the styles), #xref("software-architecture", "distributed-data-patterns", label: "Distributed Data Patterns") (sagas, outbox, CQRS data flow), #xref("software-architecture", "resilience-patterns", label: "Resilience Patterns") (handling consumer and broker failure).
