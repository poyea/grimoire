...
- *Linearisability*: operations appear instantaneous at a single point between invocation and response; the strongest practical guarantee, what etcd and ZooKeeper provide for coordination.
